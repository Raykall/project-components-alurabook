...
const SectionEstilizada = styled.section<{selecionado: boolean}>`
    width: 194px;
    height: 88px;
    background: ${props => props.selecionado ? 'linear-gradient(97.54deg,#002F52 100%,#326589 100%)' : '#FFFFFF'};
    border: 1px solid;
...
export const AbGruposDeOpcoes = ({ opcoes, onChange, valorPadrao }: AbGrupoOpcoesProps) => {
